...
class JsonReplace extends FunctionNode
{
    protected $target;
    ...
    public function getSql(SqlWalker $sqlWalker)
    {
        ...
        if(count($this->pathAndValue) > 0)
        {
            ...
            return sprintf('JSON_REPLACE(%s, %s, %s, %s)', $target, $path, $value, implode(', ', $pathAndValue));
        }

        return sprintf('JSON_REPLACE(%s, %s, %s)', $target, $path, $value);
    }
}
