...
class StringTest extends \DoctrineExtensions\Tests\Query\MysqlTestCase
{
    ...
    {
        $q = $this->entityManager->createQuery("SELECT ASCII('A') from DoctrineExtensions\Tests\Entities\Blank b");
    ...
    {
        $q = $this->entityManager->createQuery("SELECT CHAR_LENGTH(CHAR(0x65)), CHAR_LENGTH(CHAR(0x65 USING utf8)) from DoctrineExtensions\Tests\Entities\Blank b");
    ...
    {
        $q = $this->entityManager->createQuery("SELECT CONCAT_WS(',', 'First name', 'Second name', 'Last Name') from DoctrineExtensions\Tests\Entities\Blank b");
    ...
    {
        $q = $this->entityManager->createQuery("SELECT CONCAT_WS(',', 'First name', NULL, 'Last Name') from DoctrineExtensions\Tests\Entities\Blank b");
    ...
    {
        $q = $this->entityManager->createQuery("SELECT FIELD('ej', 'Hej', 'ej', 'Heja', 'hej', 'foo') from DoctrineExtensions\Tests\Entities\Blank b");
    ...
    {
        $q = $this->entityManager->createQuery("SELECT REPLACE('www.mysql.com', 'w', 'Ww') from DoctrineExtensions\Tests\Entities\Blank b");
    ...
    {
        $q = $this->entityManager->createQuery("SELECT SOUNDEX('Hello') from DoctrineExtensions\Tests\Entities\Blank b");
    ...
    {
        $q = $this->entityManager->createQuery("SELECT SUBSTRING('www.mysql.com', 1, 3) from DoctrineExtensions\Tests\Entities\Blank b");
        $this->assertEquals("SELECT SUBSTRING('www.mysql.com', 1, 3) AS sclr_0 FROM Blank b0_", $q->getSql());

        $q = $this->entityManager->createQuery("SELECT SUBSTRING('www.mysql.com', 2) from DoctrineExtensions\Tests\Entities\Blank b");
        $this->assertEquals("SELECT SUBSTRING('www.mysql.com', 2) AS sclr_0 FROM Blank b0_", $q->getSql());

        $q = $this->entityManager->createQuery("SELECT SUBSTRING('www.mysql.com', -2, 2) from DoctrineExtensions\Tests\Entities\Blank b");
   ...
   */
    ...
    {
      $q = $this->entityManager->createQuery("SELECT SUBSTRING_INDEX('www.mysql.com', '.', 2) from DoctrineExtensions\Tests\Entities\Blank b");
    ...
    {
        $q = $this->entityManager->createQuery("SELECT LPAD('Hellow', 10, '**') from DoctrineExtensions\Tests\Entities\Blank b");
    ...
    {
        $q = $this->entityManager->createQuery("SELECT RPAD('Hellow', 10, '**') from DoctrineExtensions\Tests\Entities\Blank b");
  ...
  {
    $q = $this->entityManager->createQuery("SELECT INSTR('www.mysql.com', 'mysql') from DoctrineExtensions\Tests\Entities\Blank b");
