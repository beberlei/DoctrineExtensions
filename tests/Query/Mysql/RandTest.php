...
class RandTest extends MysqlTestCase
{
    ...
    {
        $q = $this->entityManager->createQuery("SELECT RAND(2) from DoctrineExtensions\Tests\Entities\Blank b");
    ...
    {
        $q = $this->entityManager->createQuery("SELECT RAND() from DoctrineExtensions\Tests\Entities\Blank b");
